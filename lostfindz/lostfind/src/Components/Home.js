  ...
  return (
    <>
      ...
      <div data-aos="fade-right" className="main">
        <div className="intro">
          <div className="part-1">
            <div className="title">
              ...
              <p style={{ fontStyle: 'cursive' }}>Khojo 🔎 Apna Khoya Hua Saman Bade Aram Se 😉</p>
        ...
        <div className="demo_image" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <div className="demo-image-container">
    <h6 className="section-heading">Lets get started 🚀</h6>
    <img
      className="demo-image"
      src={lostandfound} // Replace with the URL or path to your image file
      alt="Demo Image"
      width="600"
      height="400"
    />
        ...
        <Container fluid>
          <div className="total-contact-form">
            <div className="contact-title">
              <h6 className="section-heading"> Contact Me 📨📬</h6>
              <p>
                If there is something you want to suggest or may be just a hello
                do reach out at <span style={{ fontWeight: 'bold' }}>anjalikumari93045@gmail.com</span>

                <a
            href="mailto:anjalikumari93045@gmail.com"
            target="_blank"
          ...
          >
            ...
            */}
            ...
            <img
              className="demo-image"
              src={plain} // Replace with the URL or path to your image file
              alt="Demo Image"
              width="200"
              height="200"
            />
      ...
      <div className="footer">
        ...
        <div className="personal-info">
          ...
          <h4>
            <span className="symbol">&#60;</span>ANJALI KUMARI
        ...
        <h5 style={{ textAlign: "center" }}>
          Copyright © 2023 ANJALI KUMARI. All rights reserved.
        </h5>
      </div>
      {/* <div className="About">
        <div>
